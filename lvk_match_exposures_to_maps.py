...
def match_exp_to_map_pixels(
    ...
    **Key Arguments:**
    ...
    exps["sql"] = f"update alert_pixels_128 set exp_{survey}_id = '" + exps["expname"].astype(str) + f"' where ipix in (" + exps["ipixs"].str + f") and exp_{survey}_id is null and mapId = {mapId};"
